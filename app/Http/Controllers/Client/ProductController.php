        ...
        if($request->cate != null){
            ...
            if(isset($request->price)){
                if($request->price == '<2000000'){
                    ...
                    $product = $product->whereBetween('price', [2000000, 4000000]);
                }elseif($request->price == '>4000000 AND <7000000'){
                    $product = $product->whereBetween('price', [4000000, 7000000]);
                }elseif($request->price == '>7000000 AND <13000000'){
                    $product = $product->whereBetween('price', [7000000, 13000000]);
                }
                else{
                    $product = $product->where('price', '>', 13000000);
                }
            }
